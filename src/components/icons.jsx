...
export function GitHubIcon(props) {
  return (
    <svg viewBox="0 0 16 16" width="20" height="20" fill="currentColor" aria-hidden="true" {...props}>
...
export function LinkedInIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="21" height="21" fill="currentColor" aria-hidden="true" {...props}>
