...
const realProjects: (RemoteProject | EmbeddedProject)[] = [
  {
    ...
    description:
      'Built from a prototype into a component-based React app: an indexed performance chart with a benchmark and time-range toggle, headline KPIs, a holdings table, and an allocation donut. You can load your own portfolio from a JSON or CSV file and it values it against live fund NAV — fetched through a small serverless proxy. It runs standalone and is exposed as a Module Federation remote.',
